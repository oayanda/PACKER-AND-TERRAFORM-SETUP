...
module "ALB" {
  source             = "./modules/ALB"
  name               = "oayanda-ext-alb"
  vpc_id             = module.Networking.vpc_id
  public-sg          = module.security.ALB-sg
  private-sg         = module.security.IALB-sg
  public-sbn-1       = module.Networking.public_subnets-1
  public-sbn-2       = module.Networking.public_subnets-2
  private-sbn-1      = module.Networking.private_subnets-1
  private-sbn-2      = module.Networking.private_subnets-2
...
module "AutoScaling" {
  ...
  public_subnets    = [module.Networking.public_subnets-1, module.Networking.public_subnets-2]
  private_subnets   = [module.Networking.private_subnets-1, module.Networking.private_subnets-2]
  keypair           = var.keypair
...
module "EFS" {
  source       = "./modules/EFS"
  efs-subnet-1 = module.Networking.private_subnets-1
  efs-subnet-2 = module.Networking.private_subnets-2
...
module "RDS" {
  ...
  private_subnets = [module.Networking.private_subnets-3, module.Networking.private_subnets-4]
}
...
#   ami-sonar       = var.ami
#   ami-jfrog       = var.ami
#   subnets-compute = module.Networking.public_subnets-1
